...
namespace ucCodeEditor
{
    public partial class textEditor : UserControl
    {
        ...
        private textEditor sourceTextBox;
        ...
        //[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public textEditor SourceTextBox
        {
        ...
        [DefaultValue(typeof (Font), "宋体, 12")]
        public override Font Font
        {
            ...
            {
                //base.Font = value;
                base.Font = new Font("宋体", 14f);
                //check monospace font
                SizeF sizeM = GetCharSize(base.Font, 'M');
                SizeF sizeDot = GetCharSize(base.Font, '.');
                if (sizeM != sizeDot)
                    base.Font = new Font("宋体", base.Font.SizeInPoints, FontStyle.Regular, GraphicsUnit.Point);
                //clac size
